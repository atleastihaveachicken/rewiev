...
:PvcBetsProps) => {
    return (
        <div className="menu__container">
            ...
            <Button onClick={() => onBet('player_1', bet)} value= {'I bet red win'} />
            <Button onClick={() => onBet('player_2', bet)} value={'i bet yellow win'} />
                </>
            ) : <p className="game__title"> You don't have enough points to make a bet! Better earn some at PvC mode</p>
                }
